...
//create some student objects
	Student Bob = new Student("Bob Marley",23, "IT",3.2,"2020ICT01");
	Student Bingu = new Student("Bingu Sala",24, "IT",3.6,"2020ICT02");
	Student China = new Student("China Kulathunga",25, "IT", 3.7,"2020ICT03");
